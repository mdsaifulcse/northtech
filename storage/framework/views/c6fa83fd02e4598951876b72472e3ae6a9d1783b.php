                ...
                <div class="card-block">
                    <div class="j-wrapper j-wrapper-640">
                        <?php echo Form::open(['route'=>'user-profile.store','method'=>'POST','class'=>'j-pro','id'=>'j-pro','files'=>'true']); ?>
                                ...
                                <div class="j-row">
                                    ...
                                    <div class="j-span6 j-unit <?php echo e($errors->has('phone_number') ? 'has-error' : ''); ?>">
                                        ...
                                        <div class="j-input">
                                            ...
                                            <input type="text" value="<?php echo e($data->mobile_no); ?>" id="phone" name="mobile_no">
                            ...
                            <!-- end /.content -->
                            <div class="j-footer">
                                <a class="btn btn-warning" href="<?php echo e(URL::to('user-profile/password')); ?>"> Change Password </a>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/ustutor1/public_html/northtech/resources/views/backend/primary_info/profile/index.blade.php ENDPATH**/ ?>