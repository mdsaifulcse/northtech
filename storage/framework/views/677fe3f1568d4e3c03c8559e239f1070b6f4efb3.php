				...
				<div class="box box-danger">
					...
					<div class="box-body ">
						...
						<div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
							...
							<div class="col-md-8">
								<?php echo e(Form::text('category_name',$value=old('category_name'),array('class'=>'form-control','placeholder'=>'Category Name','required'=>true,'autofocus'))); ?>
...
<?php echo $__env->make('backend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/ustutor1/public_html/northtech/resources/views/backend/category/index.blade.php ENDPATH**/ ?>